...
### [SSOK.apk 파일 다운](https://drive.google.com/file/d/1g3dMFG4GU4LZWEXnlLWGUFWlo0nGs4-n/view?usp=sharing)
...
- **Frontend**
  - **Flutter**
- **Backend**
  - Spring Boot | JPA | QueryDSL | Spring Cloud Config | Spring Security | JWT | Redis
  - MongoDB | MariaDB
- **Infra**
  - AWS | GCP | OCI | Nginx | Docker | Jenkins
- **API**
  - Naver Cloval OCR
  - Naver Cloud Platfrom SMS
  - Naver Map API
- **Tool**
  - GitLab | Jira | Figma | Notion | MatterMost
...
<table>
  <tr>
    <td align="center"><b>WBS</b></td>
    <td align="center"><b>ERD</b></td>
  </tr>
  <tr>
    <td align="center"><img src="exec/img/WBS.png" width="100%"></td>
    <td align="center"><img src="exec/img/ERD.png" width="100%"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center"><img src="exec/img/기능명세서1.png" width="100%">></td>
    <td align="center"><img src="exec/img/기능명세서2.png" width="100%"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center"><img src="exec/img/API명세서1.png" width="100%">></td>
    <td align="center"><img src="exec/img/API명세서2.png" width="100%"></td>
  </tr>
</table>
